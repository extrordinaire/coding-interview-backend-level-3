...
import { internal, notFound, badData } from '@hapi/boom';
...
const db_credentials = {
  ...
  user: `${parsed_env.DATABASE_USER}.${parsed_env.DATABASE_TENANT}`,
...
const zod_adapter = {
  compile: (schema) => {
    return zod_validator(schema, badData("Invalid Data Shape"));
  }
};
